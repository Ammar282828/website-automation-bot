...
async function generateEcommerceShot(imageInputs, customInstruction, angle = ANGLES[0]) {
    ...
    const sceneBlock = isDetail ? [
        ...
        '- The side of the setting, prongs, gallery, and upper band are clearly visible \u2014 this shot reveals the 3D architecture that a front view hides.',
        '- DO NOT shoot from above. The camera must be near the ring\'s eye-level, NOT looking down at it.',
        '- Every design detail from the front view (stone count, band pattern, setting type, metal color) MUST be visible and identical.',
        ...
        '- This is the SAME side of the ring visible in the front view\u2014you are just zoomed in on the band instead of the stone.',
        '- The band fills at least 70% of the frame width. The stone/setting appears at the TOP of the frame, softly visible but NOT the focus.',
        '- The SUBJECT is the band itself: its width, curvature, thickness, profile shape, surface finish, and any surface details (milgrain rows, channel-set stones, engravings).',
        '- CRITICAL: Do NOT show the BACK or INSIDE of the ring. Do NOT show the underside gallery, basket, or bridge.',
        '- STRICT: Do NOT invent decorative elements. No hearts, no scrollwork, no cutouts\u2014you can ONLY show what exists in the reference image.',
